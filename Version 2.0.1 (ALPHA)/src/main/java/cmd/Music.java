...
public class Music implements Command {
    ...
    //setzt das limit von 1000 songs
    ...
    public void action(String[] args, MessageReceivedEvent event) {
        ...
        switch (args[0].toLowerCase()) {
            ...
            case "p":
                ...
                try {
                    event.getTextChannel().sendMessage(new EmbedBuilder().setColor(Color.MAGENTA).setDescription(":white_check_mark: started song/playlist successful!").build()).queue();
                }catch (Exception exc){
            ...
            case "S":
                ...
                event.getTextChannel().sendMessage(new EmbedBuilder()
                        .setColor(Color.MAGENTA)
                        .setDescription(":arrow_left: danjeyybot left the voice Channel")
                        .build()
                ).queue();
            ...
            case "info":
                ...
                event.getTextChannel().sendMessage(
                        new EmbedBuilder()
                                .setColor(Color.MAGENTA)
                                .setThumbnail("https://raw.githubusercontent.com/D0ubleClIck/danjeyybot/master/img/audioWave.gif")
                                .setDescription(":headphones: **CURRENT TRACK INFO:** :headphones: ")
